/*!
  ...
  */
!(function(t, e) { typeof exports === 'object' && typeof module !== 'undefined' ? e(exports, require('jquery'), require('popper.js')) : typeof define === 'function' && define.amd ? define(['exports', 'jquery', 'popper.js'], e) : e(t.bootstrap = {}, t.jQuery, t.Popper); })(this, function(t, e, c) {
    'use strict';
    ...
    function i(t, e) { for(let n = 0; n < e.length; n++) { const i = e[n]; i.enumerable = i.enumerable || !1, i.configurable = !0, 'value' in i && (i.writable = !0), Object.defineProperty(t, i.key, i); } } function o(t, e, n) { return e && i(t.prototype, e), n && i(t, n), t; } function h(r) {
        for(let t = 1; t < arguments.length; t++) {
            var s = arguments[t] != null ? arguments[t] : {},
                e = Object.keys(s); typeof Object.getOwnPropertySymbols === 'function' && (e = e.concat(Object.getOwnPropertySymbols(s).filter(function(t) { return Object.getOwnPropertyDescriptor(s, t).enumerable; }))), e.forEach(function(t) {
                let e,
                    n,
                    i; e = r, i = s[n = t], n in e ? Object.defineProperty(e, n, { value: i, enumerable: !0, configurable: !0, writable: !0 }) : e[n] = i;
            });
        } return r;
        ...
        })(), m(document).on(O.CLICK_DATA_API, D, function(t) { t.preventDefault(); let e = t.target; m(e).hasClass(I) || (e = m(e).closest(N)), k._jQueryInterface.call(m(e), 'toggle'); }).on(O.FOCUS_BLUR_DATA_API, D, function(t) { const e = m(t.target).closest(N)[0]; m(e).toggleClass(A, /^focus(in)?$/.test(t.type)); }), m.fn[p] = k._jQueryInterface, m.fn[p].Constructor = k, m.fn[p].noConflict = function() { return m.fn[p] = T, k._jQueryInterface; }, k),
        ...
        })(), P(document).on(Q.CLICK_DATA_API, Z.DATA_SLIDE, $._dataApiClickHandler), P(window).on(Q.LOAD_DATA_API, function() { P(Z.DATA_RIDE).each(function() { const t = P(this); $._jQueryInterface.call(t, t.data()); }); }), P.fn[L] = $._jQueryInterface, P.fn[L].Constructor = $, P.fn[L].noConflict = function() { return P.fn[L] = W, $._jQueryInterface; }, $),
            ...
            function a(t, e) {
                ...
                let t,
                    ...
                    const i = tt.Event(at.SHOW); if(tt(this._element).trigger(i), !i.isDefaultPrevented()) {
                        t && (a._jQueryInterface.call(tt(t).not(this._selector), 'hide'), e || tt(t).data(nt, null)); const r = this._getDimension(); tt(this._element).removeClass(ht).addClass(ct), (this._element.style[r] = 0) < this._triggerArray.length && tt(this._triggerArray).removeClass(ut).attr('aria-expanded', !0), this.setTransitioning(!0); let s = `scroll${r[0].toUpperCase() + r.slice(1)}`,
                            o = Cn.getTransitionDurationFromElement(this._element); tt(this._element).one(Cn.TRANSITION_END, function() { tt(n._element).removeClass(ct).addClass(ht).addClass(lt), n._element.style[r] = '', n.setTransitioning(!1), tt(n._element).trigger(at.SHOWN); }).emulateTransitionEnd(o), this._element.style[r] = `${this._element[s]}px`;
                    }
                }
            }, t.hide = function() {
                const t = this; if(!this._isTransitioning && tt(this._element).hasClass(lt)) {
                    const e = tt.Event(at.HIDE); if(tt(this._element).trigger(e), !e.isDefaultPrevented()) {
                        ...
                        } this.setTransitioning(!0); this._element.style[n] = ''; const o = Cn.getTransitionDurationFromElement(this._element); tt(this._element).one(Cn.TRANSITION_END, function() { t.setTransitioning(!1), tt(t._element).removeClass(ct).addClass(ht).trigger(at.HIDDEN); }).emulateTransitionEnd(o);
                    }
                }
                ...
                let n = this,
                    t = null; Cn.isElement(this._config.parent) ? (t = this._config.parent, typeof this._config.parent.jquery !== 'undefined' && (t = this._config.parent[0])) : t = tt(this._config.parent)[0]; const e = `[data-toggle="collapse"][data-parent="${this._config.parent}"]`; return tt(t).find(e).each(function(t, e) { n._addAriaAndCollapsedClass(a._getTargetFromElement(e), [e]); }), t;
        ...
        wn = (Yt = 'modal', qt = `.${Gt = 'bs.modal'}`, zt = (Bt = e).fn[Yt], Xt = { backdrop: !0, keyboard: !0, focus: !0, show: !0 }, Jt = { backdrop: '(boolean|string)', keyboard: 'boolean', focus: 'boolean', show: 'boolean' }, Zt = { HIDE: `hide${qt}`, HIDDEN: `hidden${qt}`, SHOW: `show${qt}`, SHOWN: `shown${qt}`, FOCUSIN: `focusin${qt}`, RESIZE: `resize${qt}`, CLICK_DISMISS: `click.dismiss${qt}`, KEYDOWN_DISMISS: `keydown.dismiss${qt}`, MOUSEUP_DISMISS: `mouseup.dismiss${qt}`, MOUSEDOWN_DISMISS: `mousedown.dismiss${qt}`, CLICK_DATA_API: `click${qt}.data-api` }, $t = 'modal-scrollbar-measure', te = 'modal-backdrop', ee = 'modal-open', ne = 'fade', ie = 'show', re = { DIALOG: '.modal-dialog', DATA_TOGGLE: '[data-toggle="modal"]', DATA_DISMISS: '[data-dismiss="modal"]', FIXED_CONTENT: '.fixed-top, .fixed-bottom, .is-fixed, .sticky-top', STICKY_CONTENT: '.sticky-top', NAVBAR_TOGGLER: '.navbar-toggler' }, se = (function() {
            ...
            }, t._enforceFocus = function() { const e = this; Bt(document).off(Zt.FOCUSIN).on(Zt.FOCUSIN, function(t) { document !== t.target && e._element !== t.target && Bt(e._element).has(t.target).length === 0 && e._element.focus(); }); }, t._setEscapeEvent = function() { const e = this; this._isShown && this._config.keyboard ? Bt(this._element).on(Zt.KEYDOWN_DISMISS, function(t) { t.which === 27 && (t.preventDefault(), e.hide()); }) : this._isShown || Bt(this._element).off(Zt.KEYDOWN_DISMISS); }, t._setResizeEvent = function() { const e = this; this._isShown ? Bt(window).on(Zt.RESIZE, function(t) { return e.handleUpdate(t); }) : Bt(window).off(Zt.RESIZE); }, t._hideModal = function() { const t = this; this._element.style.display = 'none', this._element.setAttribute('aria-hidden', !0), this._isTransitioning = !1, this._showBackdrop(function() { Bt(document.body).removeClass(ee), t._resetAdjustments(), t._resetScrollbar(), Bt(t._element).trigger(Zt.HIDDEN); }); }, t._removeBackdrop = function() { this._backdrop && (Bt(this._backdrop).remove(), this._backdrop = null); }, t._showBackdrop = function(t) {
                let e = this,
            ...
            let e,
                n = this,
                i = Cn.getSelectorFromElement(this); i && (e = Bt(i)[0]); const r = Bt(e).data(Gt) ? 'toggle' : h({}, Bt(e).data(), Bt(this).data()); this.tagName !== 'A' && this.tagName !== 'AREA' || t.preventDefault(); var s = Bt(e).one(Zt.SHOW, function(t) { t.isDefaultPrevented() || s.one(Zt.HIDDEN, function() { Bt(n).is(':visible') && n.focus(); }); }); se._jQueryInterface.call(Bt(e), r, this);
        ...
        Nn = (ae = 'tooltip', he = `.${le = 'bs.tooltip'}`, ce = (oe = e).fn[ae], ue = 'bs-tooltip', fe = new RegExp(`(^|\\s)${ue}\\S+`, 'g'), ge = { animation: !0, template: '<div class="tooltip" role="tooltip"><div class="arrow"></div><div class="tooltip-inner"></div></div>', trigger: 'hover focus', title: '', delay: 0, html: !(_e = { AUTO: 'auto', TOP: 'top', RIGHT: 'right', BOTTOM: 'bottom', LEFT: 'left' }), selector: !(de = { animation: 'boolean', template: 'string', title: '(string|element|function)', trigger: 'string', delay: '(number|object)', html: 'boolean', selector: '(string|boolean)', placement: '(string|function)', offset: '(number|string)', container: '(string|element|boolean)', fallbackPlacement: '(string|array)', boundary: '(string|element)' }), placement: 'top', offset: 0, container: !1, fallbackPlacement: 'flip', boundary: 'scrollParent' }, pe = 'out', ve = { HIDE: `hide${he}`, HIDDEN: `hidden${he}`, SHOW: (me = 'show') + he, SHOWN: `shown${he}`, INSERTED: `inserted${he}`, CLICK: `click${he}`, FOCUSIN: `focusin${he}`, FOCUSOUT: `focusout${he}`, MOUSEENTER: `mouseenter${he}`, MOUSELEAVE: `mouseleave${he}` }, Ee = 'fade', ye = 'show', Te = '.tooltip-inner', Ce = '.arrow', Ie = 'hover', Ae = 'focus', De = 'click', be = 'manual', Se = (function() {
            function i(t, e) { if(typeof c === 'undefined') { throw new TypeError('Bootstrap tooltips require Popper.js (https://popper.js.org)'); } this._isEnabled = !0, this._timeout = 0, this._hoverState = '', this._activeTrigger = {}, this._popper = null, this.element = t, this.config = this._getConfig(e), this.tip = null, this._setListeners(); } const t = i.prototype; return t.enable = function() { this._isEnabled = !0; }, t.disable = function() { this._isEnabled = !1; }, t.toggleEnabled = function() { this._isEnabled = !this._isEnabled; }, t.toggle = function(t) {
                ...
                const i = this; this.config.trigger.split(' ').forEach(function(t) {
                    if(t === 'click') { oe(i.element).on(i.constructor.Event.CLICK, i.config.selector, function(t) { return i.toggle(t); }); } else if(t !== be) {
                        let e = t === Ie ? i.constructor.Event.MOUSEENTER : i.constructor.Event.FOCUSIN,
                            n = t === Ie ? i.constructor.Event.MOUSELEAVE : i.constructor.Event.FOCUSOUT; oe(i.element).on(e, i.config.selector, function(t) { return i._enter(t); }).on(n, i.config.selector, function(t) { return i._leave(t); });
